...
1. <span style="color: #FF4500;">Immunisation Supply Chain</span>   
...
- <span style="color: #FF4500;">1 in 5 children</span>  worldwide lack access to lifesaving vaccines.
- Globally, in 2023, <span style="color: #FF4500;">14.5 million children were zero-dose.</span> 
- An additional <span style="color: #FF4500;">6.5 million children are partially vaccinated.</span> 
- Annually, <span style="color: #FF4500;">1.5 million children under five die</span>  from vaccine-preventable diseases.
...
- <span style="color: #FF4500;">Regular administration of vaccines</span>  for infants, children, and adults  
- Builds population immunity and prevents disease  
- <span style="color: #FF4500;">Immunisation at birth is critical</span> 
...
- <span style="color: #FF4500;">Each dollar spent on immunization saves $52</span> in low- and middle-income countries (source: [CDC](https://www.cdc.gov/global-immunization/fast-facts/index.html))
...
- <span style="color: #FF4500;">Supply chain inefficiencies</span>
...
- <span style="color: #FF4500;">Inaccurate/outdated forecasting</span> 
...
2. <span style="color: #FF4500;">(Forecasting) Problem</span>  
3. Methodology  
4. Model Performance Evaluation 
5. Way Forward  
...
::: {style="margin-top: 200px; font-size: 1.2em; color: #FF4500;"}
...
- Countries use a range of forecasting tools to <span style="color: #FF4500;">support national immunisation planning and funding requests.</span> 
- These tools are developed by global partners including <span style="color: #FF4500;">UNICEF, Gavi, the Vaccine Alliance, and John Snow, Inc. (JSI).</span> 
...
- Developed by <span style="color: #FF4500;">UNICEF</span> to enhance national capacity in vaccine forecasting and supply planning
- Designed for <span style="color: #FF4500;">use by national immunisation programme managers</span>  to support multi-year vaccine planning, particularly in <span style="color: #FF4500;">low- and middle-income countries</span> 
- <span style="color: #FF4500;">Incorporates the older EPI Log Tool,</span>  which relied solely on demographic methods
- Used during <span style="color: #FF4500;">annual forecasting exercises and for multi-year planning to align supply with projected needs</span> 
...
- Developed by <span style="color: #FF4500;">Gavi, the Vaccine Alliance</span> to guide financial support for country immunisation programmes
- Used by <span style="color: #FF4500;">national governments and Gavi</span> to estimate routine vaccine needs and determine <span style="color: #FF4500;">multi-year funding allocations</span>
- Applied during <span style="color: #FF4500;">multi-year approval (MYA) and annual renewal processes</span> for Gavi-supported vaccines
- Focused on <span style="color: #FF4500;">routine immunisation only</span>, using demographic forecasting to inform co-financing responsibilities and procurement planning
...
- <span style="color: #FF4500;">Fit for national planning</span>: supports budgeting and procurement.
- <span style="color: #FF4500;">Simple and transparent</span>: easy to use, low technical barrier.
- <span style="color: #FF4500;">Globally backed</span>: aligned with funders and reporting.
- <span style="color: #FF4500;">Standardised assumptions</span>: enables cross-country comparison.
- <span style="color: #FF4500;">Evolving tools</span>: FSP integration improves accuracy.


## Limitations of Current Forecasting Tools

- <span style="color: #FF4500;">Assume perfect data</span>: not realistic in low-resource settings.
- <span style="color: #FF4500;">Ignore uncertainty</span> in demand and supply.
- <span style="color: #FF4500;">National focus</span>: misses facility-level variation.
- <span style="color: #FF4500;">Slow updates</span>: not responsive to rapid changes.
- <span style="color: #FF4500;">Fixed weights</span>: not adaptive to data quality.
...
- Tools in practice mainly use <span style="color: #FF4500;">population-based</span> forecasting.
- FSP tool combines methods, but <span style="color: #FF4500;">weighting is subjective</span>.
- Academic models: mostly population or consumption-based, <span style="color: #FF4500;">rarely both</span>.
- <span style="color: #FF4500;">No unified model</span> combining population and consumption data.
- <span style="color: #FF4500;">Forecasts rarely inform inventory decisions</span> in practice.
...
::: {.fragment }
<span style="color: #FF4500;">**RQ1:**</span> What is the most suitable consumption-based forecasting model for routine vaccine demand forecasting at national level?
:::

::: {.fragment }
<span style="color: #FF4500;">**RQ2:**</span> How can population-based features be effectively combined with consumption-based models to improve forecast accuracy and quantify uncertainty?
:::

::: {.fragment}
<span style="color: #FF4500;">**RQ3:**</span> How can improved probabilistic forecasts be integrated into inventory decision-making for better vaccine supply chain management?
:::
...
1. Immunisation Supply Chain  
2. (Forecasting) Problem
3. <span style="color: #FF4500;">Methodology</span>    
4. Model Performance Evaluation 
5. Way Forward  
:::
...
- Four vaccines:
  - <span style="color: #FF4500;">Measles~rubella</span>
  - <span style="color: #FF4500;">BCG</span> – for tuberculosis
  - <span style="color: #FF4500;">Penta</span> – combination vaccine for diphtheria, tetanus, pertussis, hepatitis B, and Hib
  - <span style="color: #FF4500;">OPV</span> – oral polio vaccine


## Data Structure

  ![](images/heirerachy.png){width=150% fig-align="center"}



## Doses administrated: National and Regional 
![](images/national_regional.png){width=150% fig-align="center"}
...
- Forecasting methods:  <span style="color: #FF4500;">Naive, Seasonal Naive, ARIMA, ETS, Linear Regression, Gradient Boosting (GBM, quantile regression) </span>
- Forecast horizon:  <span style="color: #FF4500;">12 months</span>
- Target: Doses Administered
- Cross-sectional training across vaccines with monthly data, using an <span style="color: #FF4500;">expanding window approach</span> 
...
2. (Forecasting) Problem
3. Methodology    
4. <span style="color: #FF4500;">Model Performance Evaluation</span> 
5. Way Forward  
:::
...
bcg_table <- data.frame(
  Model = c("AutoARIMA", "LinearRegression", "GBM", "SeasonalNaive", "AutoETS"),
  MASE = c(0.7479, 0.7649, 0.7888, 0.8105, 0.8651),
  RMSSE = c(0.5460, 0.5584, 0.5556, 0.5916, 0.6315)
)
kable(bcg_table, format = "html", digits = 4) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover")) %>%
  row_spec(0, background = "#00274D", color = "white") %>%
  row_spec(3, background = "#FFF2CC") # Highlight GBM row (row 3: 1=AutoARIMA, 2=LinearRegression, 3=GBM)
```
</div>
...
penta_table <- data.frame(
  Model = c("GBM", "SeasonalNaive", "AutoARIMA", "AutoETS", "LinearRegression"),
  MASE = c(0.6672, 1.0888, 1.4564, 1.8076, 2.8568),
  RMSSE = c(0.5046, 0.6681, 0.8937, 1.1092, 1.7530)
)
kable(penta_table, format = "html", digits = 4) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover")) %>%
  row_spec(0, background = "#00274D", color = "white")
```
</div>
...
```{r}
mr_table <- data.frame(
  Model = c("AutoARIMA", "AutoETS", "GBM", "SeasonalNaive", "LinearRegression"),
  MASE = c(0.6762, 0.7434, 0.7562, 1.1277, 2.0586),
  RMSSE = c(0.5235, 0.5756, 0.4385, 0.8731, 1.5939)
)
kable(mr_table, format = "html", digits = 4) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover")) %>%
  row_spec(0, background = "#00274D", color = "white") %>%
  row_spec(3, background = "#FFF2CC") # Highlight GBM row (row 3)
```
</div>
...
opv_table <- data.frame(
  Model = c("GBM", "LinearRegression", "SeasonalNaive", "AutoARIMA", "AutoETS"),
  MASE = c(0.7442, 0.8162, 0.8791, 1.2962, 1.4534),
  RMSSE = c(0.5609, 0.5696, 0.6135, 0.9046, 1.0143)
)
kable(opv_table, format = "html", digits = 4) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover")) %>%
  row_spec(0, background = "#00274D", color = "white")
```
</div>
...
![](images/metrics_plot.png){width=100% fig-align="center"}
...
3. Methodology  
4. Model Performance Evaluation 
5. <span style="color: #FF4500;">Way Forward</span>    
:::
...
![](images/nextsteps.png){width=100% fig-align="center"}
