...
bcg_table <- data.frame(
  ...
  MASE = c(0.788761, 0.791638, 0.796465, 0.856192, 0.906216, 2.506803),
  RMSSE = c(0.737327, 0.725550, 0.689527, 0.792913, 0.809989, 1.964830)
)
...
penta_table <- data.frame(
  ...
  MASE = c(0.667200, 1.212922, 1.565548, 1.894074, 3.308408, 3.602789),
  RMSSE = c(0.600996, 0.957851, 1.120036, 1.351566, 2.299248, 2.473502)
)
...
mr_table <- data.frame(
  ...
  MASE = c(0.676176, 0.743397, 0.758435, 1.127701, 2.058642, 2.852494),
  RMSSE = c(0.630862, 0.742965, 0.515121, 1.204783, 1.786717, 2.303965)
)
...
opv_table <- data.frame(
  ...
  MASE = c(0.775939, 0.839672, 0.926087, 1.350139, 1.533141, 2.691505),
  RMSSE = c(0.695059, 0.711860, 0.841312, 1.047141, 1.199226, 2.047815)
)
