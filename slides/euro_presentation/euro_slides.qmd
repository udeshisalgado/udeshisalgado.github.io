...
- Used by <span style="color: #FF4500;">national governments and Gavi</span> to estimate routine vaccine needs and determine <span style="color: #FF4500;">multi-year funding allocations for Gavi-supported vaccines</span>
...
::: {.fragment }
<span style="color: #FF4500;">**RQ1:**</span> What is the most suitable consumption-based forecasting model for routine vaccine demand at national level?
:::
...
- Forecasting methods:  <span style="color: #FF4500;">Seasonal Naive, ARIMA, ETS, Linear Regression, Gradient Boosting (GBM, quantile regression) </span>
