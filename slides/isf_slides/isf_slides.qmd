...
[We bound each forecast with the *administered* FSP demographic: the eligible cohort × dose schedule at full (100%) coverage. The lower bound is structural; the upper bound is calibrated from history.]{.fsp-lead style="display:block; text-align:center;"}
...
[**Calibrate** $k_{i,v} = Q_{0.975}\!\left(\tfrac{y}{E}\,\big|\,2018\text{–}19\right)$ on the administered FSP point forecast, where the central capacity is $E = \text{Target Population} \times \,\text{No of doses} \times \,\text{100% coverage} /12$. <br>
**Apply** to the upper capacity $E^{\uparrow} = \text{Target Population Upper} \times \,\text{No of doses} \times \,\text{100% coverage}/12$ (the upper cohort at 100% coverage) to set the feasibility ceiling.]{.fsp-lead}
:::
::::
