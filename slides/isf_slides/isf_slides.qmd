...
$$\text{Annual } Q^{\mathrm{adm}}_{\mathrm{dem}} = P \cdot \frac{c}{100} \cdot d
\qquad\Longrightarrow\qquad
\text{Monthly FSP informed admin} = \tfrac{1}{12}\, P \cdot \frac{c}{100} \cdot d$$
...
## Distributional post-processing: Calibration {.eqn-slide}
...
![](images/res_box_rmsse.png){width=52% fig-align="center"}
