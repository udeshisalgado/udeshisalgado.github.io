...
- Review Panel Convenor: Danni Zhang
...
Addressing inefficiencies in <span style="color: #20808D;">infant routine vaccine supply chains</span>, which includes:
...
- the exclusion of societal well-being metrics like DALYs and QALYs.
...
- These inefficiencies result in stockouts, wastage, and missed vaccination opportunities, contributing to the preventable deaths
    - <span style="color: #20808D;">1 in 5 children</span>  worldwide lack access to lifesaving vaccines.
    - Globally, in 2023, <span style="color: #20808D;">14.5 million children were zero-dose.</span> 
    - An additional <span style="color: #20808D;">6.5 million children are partially vaccinated.</span> 
    - Annually, <span style="color: #20808D;">1.5 million children under five die</span>  from vaccine-preventable diseases.
- Solving this problem can save lives, reduce healthcare inequalities, and improve the efficiency of vaccine distribution.
...
- The research benefits public health systems, humanitarian organizations (e.g., UNICEF, GAVI), and vulnerable populations in developing countries
...
Conducted the following training sessions for members of the Data Lab for Social Good (DLSG) research group:

- Introduction to Python - March 3, 2025
- Introduction to Continuous Markov Chains & Queueing Theory in Healthcare Supply Chains - May 22, 2025
